  ...
  return (
    <main className="min-h-screen pt-32 md:pt-40 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div
          id="vysledky"
          className="col-span-1 relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-sysmex-900 to-sysmex-950 p-5 md:p-8 flex flex-col justify-between group hover:border-neon-gold/50 hover:shadow-[0_0_20px_-8px_rgba(251,217,134,0.25)] transition-all duration-300"
        >
